---
name: agent-factory
description: Use to create or materially change an agent definition in awesome-ai-utmostcreator — decides reuse vs. create, produces a strict AgentSpec, runs deterministic static validation, checks semantic fit and runtime guardrails, and holds for human approval. Produces specs, never runs the created agent.
