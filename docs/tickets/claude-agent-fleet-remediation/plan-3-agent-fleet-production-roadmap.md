...
- [ ] P0: Route this plan through architect to validate schema design against existing in-flight permission tickets (`arch-todo-agent-permission-rethink-20260613T154104Z`, `arch-todo-implementer-permission-profile-pilot-20260706-215934`, `arch-todo-implementer-permission-line-reduction-pilot-20260706-233000`, and the existing `tools/ai/install/permission-layers/` composition engine) before any Phase 1 implementation starts. This item gates every other item below.
