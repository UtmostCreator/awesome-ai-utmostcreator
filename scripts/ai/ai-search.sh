...
_search_dir="$(CDPATH= cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)/internal/search"

# shellcheck source=scripts/ai/internal/search/00-bootstrap.sh
source "$_search_dir/00-bootstrap.sh"
# shellcheck source=scripts/ai/internal/search/10-contract.sh
source "$_search_dir/10-contract.sh"
# shellcheck source=scripts/ai/internal/search/20-state.sh
source "$_search_dir/20-state.sh"
# shellcheck source=scripts/ai/internal/search/25-modes.sh
source "$_search_dir/25-modes.sh"
# shellcheck source=scripts/ai/internal/search/40-output-json.sh
source "$_search_dir/40-output-json.sh"
# shellcheck source=scripts/ai/internal/search/45-results-rg.sh
source "$_search_dir/45-results-rg.sh"
# shellcheck source=scripts/ai/internal/search/50-results-context.sh
source "$_search_dir/50-results-context.sh"
# shellcheck source=scripts/ai/internal/search/30-parse-flags.sh
source "$_search_dir/30-parse-flags.sh"
# shellcheck source=scripts/ai/internal/search/35-parse-positionals.sh
source "$_search_dir/35-parse-positionals.sh"
# shellcheck source=scripts/ai/internal/search/55-scope-args.sh
source "$_search_dir/55-scope-args.sh"
# shellcheck source=scripts/ai/internal/search/60-guards.sh
source "$_search_dir/60-guards.sh"
# shellcheck source=scripts/ai/internal/search/65-backend-files.sh
source "$_search_dir/65-backend-files.sh"
# shellcheck source=scripts/ai/internal/search/70-backend-text.sh
source "$_search_dir/70-backend-text.sh"
# shellcheck source=scripts/ai/internal/search/75-backend-git.sh
source "$_search_dir/75-backend-git.sh"
# shellcheck source=scripts/ai/internal/search/80-backend-curated.sh
source "$_search_dir/80-backend-curated.sh"
# shellcheck source=scripts/ai/internal/search/85-backend-ast.sh
source "$_search_dir/85-backend-ast.sh"
# shellcheck source=scripts/ai/internal/search/90-doctor.sh
source "$_search_dir/90-doctor.sh"
# shellcheck source=scripts/ai/internal/search/95-dispatch.sh
