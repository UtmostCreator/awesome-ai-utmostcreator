...
# Role/risk alias for the canonical implementation at scripts/ai/pre-tool-use.sh.
# Provides scripts/ai/bin/hooks/pre-tool-use.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/hooks/pre-tool-use.sh,
...
_ai_impl="$_ai_root/pre-tool-use.sh"
