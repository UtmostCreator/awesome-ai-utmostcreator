...
# Role/risk alias for the canonical implementation at scripts/ai/post-tool-use.sh.
# Provides scripts/ai/bin/hooks/post-tool-use.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/hooks/post-tool-use.sh,
...
_ai_impl="$_ai_root/post-tool-use.sh"
