...
# Role/risk alias for the canonical implementation at scripts/ai/session-checkpoint.sh.
# Provides scripts/ai/bin/hooks/session-checkpoint.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/hooks/session-checkpoint.sh,
...
_ai_impl="$_ai_root/session-checkpoint.sh"
