...
# Role/risk alias for the canonical implementation at scripts/ai/watch-loop.sh.
# Provides scripts/ai/bin/hooks/watch-loop.sh addressability without relocating
