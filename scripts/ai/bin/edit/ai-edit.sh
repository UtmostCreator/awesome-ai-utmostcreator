...
# Role/risk alias for the canonical implementation at scripts/ai/ai-edit.sh.
# Provides scripts/ai/bin/edit/ai-edit.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/edit/ai-edit.sh,
