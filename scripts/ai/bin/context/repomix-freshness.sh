...
# Role/risk alias for the canonical implementation at scripts/ai/repomix-freshness.sh.
# Provides scripts/ai/bin/context/repomix-freshness.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/context/repomix-freshness.sh,
...
_ai_impl="$_ai_root/repomix-freshness.sh"
