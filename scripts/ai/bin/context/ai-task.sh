...
# Role/risk alias for the canonical implementation at scripts/ai/ai-task.sh.
# Provides scripts/ai/bin/context/ai-task.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/context/ai-task.sh,
