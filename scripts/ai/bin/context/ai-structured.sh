...
# Role/risk alias for the canonical implementation at scripts/ai/ai-structured.sh.
# Provides scripts/ai/bin/context/ai-structured.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/context/ai-structured.sh,
...
_ai_impl="$_ai_root/ai-structured.sh"
