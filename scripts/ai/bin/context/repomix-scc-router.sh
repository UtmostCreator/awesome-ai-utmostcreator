...
# Role/risk alias for the canonical implementation at scripts/ai/repomix-scc-router.sh.
# Provides scripts/ai/bin/context/repomix-scc-router.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/context/repomix-scc-router.sh,
...
_ai_impl="$_ai_root/repomix-scc-router.sh"
