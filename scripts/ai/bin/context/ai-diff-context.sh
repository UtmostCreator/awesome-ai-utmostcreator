...
# Role/risk alias for the canonical implementation at scripts/ai/ai-diff-context.sh.
# Provides scripts/ai/bin/context/ai-diff-context.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/context/ai-diff-context.sh,
...
_ai_impl="$_ai_root/ai-diff-context.sh"
