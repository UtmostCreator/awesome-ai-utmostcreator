...
# Role/risk alias for the canonical implementation at scripts/ai/run-repomix-context.sh.
# Provides scripts/ai/bin/context/run-repomix-context.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/context/run-repomix-context.sh,
...
_ai_impl="$_ai_root/run-repomix-context.sh"
