...
# Role/risk alias for the canonical implementation at scripts/ai/run-repomix-file.sh.
# Provides scripts/ai/bin/context/run-repomix-file.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/context/run-repomix-file.sh,
...
_ai_impl="$_ai_root/run-repomix-file.sh"
