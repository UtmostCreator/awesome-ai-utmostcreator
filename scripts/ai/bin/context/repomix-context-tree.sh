...
# Role/risk alias for the canonical implementation at scripts/ai/repomix-context-tree.sh.
# Provides scripts/ai/bin/context/repomix-context-tree.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/context/repomix-context-tree.sh,
...
_ai_impl="$_ai_root/repomix-context-tree.sh"
