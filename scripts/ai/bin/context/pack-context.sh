...
# Role/risk alias for the canonical implementation at scripts/ai/pack-context.sh.
# Provides scripts/ai/bin/context/pack-context.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/context/pack-context.sh,
...
_ai_impl="$_ai_root/pack-context.sh"
