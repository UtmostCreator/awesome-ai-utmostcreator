...
# Role/risk alias for the canonical implementation at scripts/ai/ai-doc-check.sh.
# Provides scripts/ai/bin/verify/ai-doc-check.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/verify/ai-doc-check.sh,
...
_ai_impl="$_ai_root/ai-doc-check.sh"
