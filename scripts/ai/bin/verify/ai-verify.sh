...
# Role/risk alias for the canonical implementation at scripts/ai/ai-verify.sh.
# Provides scripts/ai/bin/verify/ai-verify.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/verify/ai-verify.sh,
...
_ai_impl="$_ai_root/ai-verify.sh"
