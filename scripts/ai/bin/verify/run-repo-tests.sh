...
# Role/risk alias for the canonical implementation at scripts/ai/run-repo-tests.sh.
# Provides scripts/ai/bin/verify/run-repo-tests.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/verify/run-repo-tests.sh,
...
_ai_impl="$_ai_root/run-repo-tests.sh"
