...
# Role/risk alias for the canonical implementation at scripts/ai/check-file-refs.sh.
# Provides scripts/ai/bin/verify/check-file-refs.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/verify/check-file-refs.sh,
...
_ai_impl="$_ai_root/check-file-refs.sh"
