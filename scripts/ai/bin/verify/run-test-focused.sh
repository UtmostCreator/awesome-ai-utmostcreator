...
# Role/risk alias for the canonical implementation at scripts/ai/run-test-focused.sh.
# Provides scripts/ai/bin/verify/run-test-focused.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/verify/run-test-focused.sh,
...
_ai_impl="$_ai_root/run-test-focused.sh"
