...
# Role/risk alias for the canonical implementation at scripts/ai/ai-test-select.sh.
# Provides scripts/ai/bin/verify/ai-test-select.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/verify/ai-test-select.sh,
...
_ai_impl="$_ai_root/ai-test-select.sh"
