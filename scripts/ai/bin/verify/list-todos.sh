...
# Role/risk alias for the canonical implementation at scripts/ai/list-todos.sh.
# Provides scripts/ai/bin/verify/list-todos.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/verify/list-todos.sh,
...
_ai_impl="$_ai_root/list-todos.sh"
