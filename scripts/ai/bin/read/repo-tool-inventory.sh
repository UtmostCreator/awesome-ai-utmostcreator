...
# Role/risk alias for the canonical implementation at scripts/ai/repo-tool-inventory.sh.
# Provides scripts/ai/bin/read/repo-tool-inventory.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/read/repo-tool-inventory.sh,
...
_ai_impl="$_ai_root/repo-tool-inventory.sh"
