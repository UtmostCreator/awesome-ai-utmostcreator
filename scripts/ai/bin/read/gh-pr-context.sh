...
# Role/risk alias for the canonical implementation at scripts/ai/gh-pr-context.sh.
# Provides scripts/ai/bin/read/gh-pr-context.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/read/gh-pr-context.sh,
...
_ai_impl="$_ai_root/gh-pr-context.sh"
