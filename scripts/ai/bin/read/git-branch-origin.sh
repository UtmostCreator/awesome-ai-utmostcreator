...
# Role/risk alias for the canonical implementation at scripts/ai/git-branch-origin.sh.
# Provides scripts/ai/bin/read/git-branch-origin.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/read/git-branch-origin.sh,
...
_ai_impl="$_ai_root/git-branch-origin.sh"
