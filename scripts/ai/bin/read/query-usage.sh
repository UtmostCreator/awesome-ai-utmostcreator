...
# Role/risk alias for the canonical implementation at scripts/ai/query-usage.sh.
# Provides scripts/ai/bin/read/query-usage.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/read/query-usage.sh,
...
_ai_impl="$_ai_root/query-usage.sh"
