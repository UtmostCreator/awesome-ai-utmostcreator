...
# Role/risk alias for the canonical implementation at scripts/ai/sh-introspect.sh.
# Provides scripts/ai/bin/read/sh-introspect.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/read/sh-introspect.sh,
...
_ai_impl="$_ai_root/sh-introspect.sh"
