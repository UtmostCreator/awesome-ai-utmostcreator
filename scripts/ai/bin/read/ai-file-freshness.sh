...
# Role/risk alias for the canonical implementation at scripts/ai/ai-file-freshness.sh.
# Provides scripts/ai/bin/read/ai-file-freshness.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/read/ai-file-freshness.sh,
...
_ai_impl="$_ai_root/ai-file-freshness.sh"
