...
# Role/risk alias for the canonical implementation at scripts/ai/preview-file.sh.
# Provides scripts/ai/bin/read/preview-file.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/read/preview-file.sh,
...
_ai_impl="$_ai_root/preview-file.sh"
