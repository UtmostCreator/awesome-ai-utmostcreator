...
# Role/risk alias for the canonical implementation at scripts/ai/ai-search-introspect.sh.
# Provides scripts/ai/bin/read/ai-search-introspect.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/read/ai-search-introspect.sh,
...
_ai_impl="$_ai_root/ai-search-introspect.sh"
