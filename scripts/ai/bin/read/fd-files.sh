...
# Role/risk alias for the canonical implementation at scripts/ai/fd-files.sh.
# Provides scripts/ai/bin/read/fd-files.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/read/fd-files.sh,
