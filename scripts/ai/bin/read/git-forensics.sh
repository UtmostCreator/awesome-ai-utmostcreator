...
# Role/risk alias for the canonical implementation at scripts/ai/git-forensics.sh.
# Provides scripts/ai/bin/read/git-forensics.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/read/git-forensics.sh,
...
_ai_impl="$_ai_root/git-forensics.sh"
