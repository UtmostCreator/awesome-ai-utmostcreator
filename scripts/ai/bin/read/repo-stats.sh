...
# Role/risk alias for the canonical implementation at scripts/ai/repo-stats.sh.
# Provides scripts/ai/bin/read/repo-stats.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/read/repo-stats.sh,
...
_ai_impl="$_ai_root/repo-stats.sh"
