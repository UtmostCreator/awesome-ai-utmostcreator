...
# Role/risk alias for the canonical implementation at scripts/ai/rg-code.sh.
# Provides scripts/ai/bin/read/rg-code.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/read/rg-code.sh,
