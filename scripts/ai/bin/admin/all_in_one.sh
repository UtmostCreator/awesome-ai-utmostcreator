...
# Role/risk alias for the canonical implementation at scripts/ai/all_in_one.sh.
# Provides scripts/ai/bin/admin/all_in_one.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/admin/all_in_one.sh,
...
_ai_impl="$_ai_root/all_in_one.sh"
