...
# Role/risk alias for the canonical implementation at scripts/ai/build-ai-help-bundle.sh.
# Provides scripts/ai/bin/admin/build-ai-help-bundle.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/admin/build-ai-help-bundle.sh,
...
_ai_impl="$_ai_root/build-ai-help-bundle.sh"
