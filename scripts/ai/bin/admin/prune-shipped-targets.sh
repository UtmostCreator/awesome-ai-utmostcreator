...
# Role/risk alias for the canonical implementation at scripts/ai/prune-shipped-targets.sh.
# Provides scripts/ai/bin/admin/prune-shipped-targets.sh addressability without relocating
...
# Resolve the scripts/ai root: this shim lives at scripts/ai/bin/admin/prune-shipped-targets.sh,
...
_ai_impl="$_ai_root/prune-shipped-targets.sh"
