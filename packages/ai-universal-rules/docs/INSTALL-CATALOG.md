<!-- GENERATED — DO NOT EDIT: generated by installer catalog renderer. -->
...
- `base` (24 items)
- `adapter-copilot` (11 items)
- `adapter-opencode` (7 items)
- `adapter-claude` (7 items)
...
- `ai-search-multi` -> `scripts/ai/ai-search-multi.sh`
...
- `ship-audit` -> `scripts/ai/ship-audit.sh`
- `sh-introspect` -> `scripts/ai/sh-introspect.sh`
