...
function aiInstallerWriteSetupDocs(string $targetRoot, array $manifest): void
{
    ...
    $header = aiInstallerGeneratedMarkdownHeader('installer setup docs');

    $setup = $header . "# AI Setup\n\n";
    ...
    $installedFiles = $header . "# Installed Files\n\n";
    foreach ($files as $file) {
        $installedFiles .= "- `{$file}`\n";
    }

    $projectConfig = $header . "# Project Configuration\n\n";
    ...
    $availablePacks = $header . "# Available Packs\n\n";
    ...
    $postInstall = $header . "# Post Install\n\n";
    ...
    $summary = $header . "# Install Summary\n\n";
